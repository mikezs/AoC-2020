...
"""
    ...
    func testDay19Part1() {
        ...
        XCTAssertEqual(Day19(input: day19Input2).part1(), 0)
    }

    func testDay19Part2() {
        XCTAssertEqual(Day19(input: day19Part2Input).part2(), 12)
    }
...
"""
    ...
    func testDay23Part2() {
        //XCTAssertEqual(Day23(input: day23Input).part2(), 149245887792)
    }
